...
- os gráficos mostram **nível/abertura (PA e PB)**, **química e distúrbios** (TC, perda de
  soda, chuva) e a **vazão de alimentação** (L/s, com a oscilação do distúrbio "Variação de
  alimentação");
